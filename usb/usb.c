...
*                                                                              *
* DESCRIPTION:                                                                 *
* 	    Remove garbage USB data by cycling receiving data until a timeout      *
...
/*------------------------------------------------------------------------------
 Local Variables
------------------------------------------------------------------------------*/
USB_STATUS usb_status; /* Status codes from USB API calls */
uint8_t    rx_data;    /* Data received from USB          */
...
/*------------------------------------------------------------------------------
 Call usb_receive() until timeout 
------------------------------------------------------------------------------*/
while ( usb_status != USB_TIMEOUT )
	{
	usb_status = usb_receive( &rx_data, sizeof( rx_data ), HAL_DEFAULT_TIMEOUT );
	}
} /* usb_flush */
